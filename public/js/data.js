...
const services = [
  // ===== RECOMMENDED =====
  { id: 'wa', name: 'WhatsApp', region: 'United States', country: 'us', icon: 'fab fa-whatsapp', iconClass: 'wa', price: 0.70, category: 'recommended' },
  { id: 'tg', name: 'Telegram', region: 'United States', country: 'us', icon: 'fab fa-telegram-plane', iconClass: 'telegram', price: 0.45, category: 'recommended' },
  { id: 'google', name: 'Google, Youtube, Gmail', region: 'United States', country: 'us', icon: 'fab fa-google', iconClass: 'google', price: 0.35, category: 'recommended' },
  { id: 'fb', name: 'Facebook', region: 'United States', country: 'us', icon: 'fab fa-facebook-f', iconClass: 'fb', price: 0.50, category: 'recommended' },
  { id: 'ig', name: 'Instagram+Threads', region: 'United States', country: 'us', icon: 'fab fa-instagram', iconClass: 'instagram', price: 0.60, category: 'recommended' },
  
  // ===== FIXED: CHANGED TO UK AND $0.20 PRICE =====
  { id: 'tk', name: 'TikTok/Douyin', region: 'United Kingdom', country: 'gb', icon: 'fab fa-tiktok', iconClass: 'tiktok', price: 0.20, category: 'recommended' },
  
  // ===== ANY OTHER =====
  { id: 'any-other', name: 'Any other', region: 'United States', country: 'US', icon: 'fas fa-question-circle', iconClass: 'other', price: 0.90, category: 'recommended' },

  // ===== SOCIAL MEDIA =====
  { id: 'vk', name: 'VKontakte (В Контакте)', region: 'United States', country: 'us', icon: 'fab fa-vk', iconClass: 'other', price: 0.45, category: 'social' },
  { id: 'tw', name: 'Twitter', region: 'United States', country: 'us', icon: 'fab fa-x-twitter', iconClass: 'twitter', price: 0.55, category: 'social' },
  { id: 'linkedin', name: 'LinkedIn', region: 'United States', country: 'us', icon: 'fab fa-linkedin', iconClass: 'other', price: 0.60, category: 'social' },
  { id: 'snapchat', name: 'Snapchat', region: 'United States', country: 'us', icon: 'fab fa-snapchat', iconClass: 'other', price: 0.55, category: 'social' },
  { id: 'tinder', name: 'Tinder', region: 'United States', country: 'us', icon: 'fas fa-fire', iconClass: 'other', price: 0.65, category: 'social' },
  { id: 'bumble', name: 'Bumble', region: 'United States', country: 'us', icon: 'fas fa-bolt', iconClass: 'other', price: 0.60, category: 'social' },
  { id: 'hinge', name: 'Hinge', region: 'United States', country: 'us', icon: 'fas fa-heart', iconClass: 'other', price: 0.55, category: 'social' },
  { id: 'okcupid', name: 'OkCupid', region: 'United States', country: 'us', icon: 'fas fa-heart', iconClass: 'other', price: 0.50, category: 'social' },
  { id: 'match', name: 'Match', region: 'United States', country: 'us', icon: 'fas fa-heart', iconClass: 'other', price: 0.65, category: 'social' },
  { id: 'zoosk', name: 'Zoosk', region: 'United States', country: 'us', icon: 'fas fa-heart', iconClass: 'other', price: 0.55, category: 'social' },
  { id: 'happn', name: 'Happn', region: 'United States', country: 'us', icon: 'fas fa-heart', iconClass: 'other', price: 0.50, category: 'social' },
  { id: 'wild', name: 'Wild App', region: 'United States', country: 'us', icon: 'fas fa-leaf', iconClass: 'other', price: 0.45, category: 'social' },
  { id: 'bereal', name: 'BeReal', region: 'United States', country: 'us', icon: 'fas fa-camera', iconClass: 'other', price: 0.50, category: 'social' },
  { id: 'lemon8', name: 'Lemon8', region: 'United States', country: 'us', icon: 'fas fa-lemon', iconClass: 'other', price: 0.45, category: 'social' },
  { id: 'yikyak', name: 'Yikyak', region: 'United States', country: 'us', icon: 'fas fa-comment', iconClass: 'other', price: 0.40, category: 'social' },
  { id: 'truthsocial', name: 'Truthsocial', region: 'United States', country: 'us', icon: 'fas fa-bullhorn', iconClass: 'other', price: 0.55, category: 'social' },
  { id: 'warpcast', name: 'Warpcast', region: 'United States', country: 'us', icon: 'fas fa-rocket', iconClass: 'other', price: 0.60, category: 'social' },
  { id: 'friendtech', name: 'Friendtech', region: 'United States', country: 'us', icon: 'fas fa-users', iconClass: 'other', price: 0.65, category: 'social' },

  // ===== MESSAGING & CHAT =====
  { id: 'vb', name: 'Viber', region: 'United States', country: 'us', icon: 'fas fa-phone', iconClass: 'other', price: 0.45, category: 'social' },
  { id: 'kakao', name: 'KakaoTalk', region: 'United States', country: 'us', icon: 'fas fa-comment', iconClass: 'other', price: 0.50, category: 'social' },
  { id: 'line', name: 'Line', region: 'United States', country: 'us', icon: 'fas fa-comment-dots', iconClass: 'other', price: 0.45, category: 'social' },
  { id: 'imo', name: 'Imo', region: 'United States', country: 'us', icon: 'fas fa-comment', iconClass: 'other', price: 0.40, category: 'social' },
  { id: 'icq', name: 'ICQ', region: 'United States', country: 'us', icon: 'fas fa-comment', iconClass: 'other', price: 0.35, category: 'social' },
  { id: 'sk', name: 'Skype', region: 'United States', country: 'us', icon: 'fab fa-skype', iconClass: 'other', price: 0.50, category: 'social' },
  { id: 'signal', name: 'Signal', region: 'United States', country: 'us', icon: 'fas fa-shield-alt', iconClass: 'other', price: 0.55, category: 'social' },
  { id: 'tamtam', name: 'TamTam', region: 'United States', country: 'us', icon: 'fas fa-comment', iconClass: 'other', price: 0.40, category: 'social' },
  { id: 'botim', name: 'Botim', region: 'United States', country: 'us', icon: 'fas fa-phone', iconClass: 'other', price: 0.45, category: 'social' },
  { id: 'mchat', name: 'MChat', region: 'United States', country: 'us', icon: 'fas fa-comment', iconClass: 'other', price: 0.40, category: 'social' },
  { id: 'zalo', name: 'Zalo', region: 'United States', country: 'us', icon: 'fas fa-comment', iconClass: 'other', price: 0.45, category: 'social' },
  { id: 'kwai', name: 'Kwai', region: 'United States', country: 'us', icon: 'fas fa-video', iconClass: 'other', price: 0.50, category: 'social' },
  { id: 'azar', name: 'Azar', region: 'United States', country: 'us', icon: 'fas fa-video', iconClass: 'other', price: 0.45, category: 'social' },
  { id: 'tantan', name: 'Tantan', region: 'United States', country: 'us', icon: 'fas fa-heart', iconClass: 'other', price: 0.50, category: 'social' },
  { id: 'yalla', name: 'Yalla', region: 'United States', country: 'us', icon: 'fas fa-gamepad', iconClass: 'other', price: 0.55, category: 'social' },
  { id: 'groupme', name: 'GroupMe', region: 'United States', country: 'us', icon: 'fas fa-users', iconClass: 'other', price: 0.45, category: 'social' },
  { id: 'twitch', name: 'Twitch', region: 'United States', country: 'us', icon: 'fab fa-twitch', iconClass: 'other', price: 0.50, category: 'social' },
  ...
  { id: 'ub', name: 'Uber', region: 'United States', country: 'us', icon: 'fab fa-uber', iconClass: 'uber', price: 0.75, category: 'ecommerce' },
  { id: 'steam', name: 'Steam', region: 'United States', country: 'us', icon: 'fab fa-steam', iconClass: 'steam', price: 0.65, category: 'ecommerce' },
  { id: 'aliexpress', name: 'AliExpress', region: 'United States', country: 'us', icon: 'fab fa-alipay', iconClass: 'other', price: 0.85, category: 'ecommerce' },
  { id: 'ebay', name: 'eBay', region: 'United States', country: 'us', icon: 'fab fa-ebay', iconClass: 'other', price: 0.70, category: 'ecommerce' },
  { id: 'shopee', name: 'Shopee', region: 'United States', country: 'us', icon: 'fas fa-shopping-bag', iconClass: 'other', price: 0.60, category: 'ecommerce' },
  { id: 'lazada', name: 'Lazada', region: 'United States', country: 'us', icon: 'fas fa-shopping-cart', iconClass: 'other', price: 0.65, category: 'ecommerce' },
  ...
  { id: 'pubg', name: '‎PUBG MOBILE', region: 'United States', country: 'us', icon: 'fas fa-gamepad', iconClass: 'other', price: 0.65, category: 'popular' },
